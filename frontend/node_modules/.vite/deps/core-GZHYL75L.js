...
import "./chunk-E5WW4EUF.js";
import {
  toHex
} from "./chunk-UUTIC7SY.js";
import "./chunk-SO5UNBJ5.js";
...
var AppKitBaseClient = class {
  constructor(options) {
    ...
    this.getCaipNetwork = (chainNamespace, id) => {
      if (chainNamespace) {
        const caipNetworkWithId = ChainController.getCaipNetworks(chainNamespace)?.find((c3) => c3.id === id);
  ...
  async initialize(options) {
    ...
    if (OptionsController.state.features?.reownAuthentication || OptionsController.state.remoteFeatures?.reownAuthentication) {
      const { ReownAuthentication } = await import("./features-RBXR6MXD.js");
    ...
    if (providerType === ConstantsUtil3.CONNECTOR_TYPE_ANNOUNCED || providerType === ConstantsUtil3.CONNECTOR_TYPE_INJECTED) {
      if (connectorId) {
        ...
        const connector = connectors.find((c3) => {
          ...
          const isRdns = c3.info?.rdns === connectorId;
          const hasMultiChainConnector = c3.connectors?.some((_c2) => _c2.id === connectorId || _c2.info?.rdns === connectorId);
...
var AppKit = class extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import("./basic-MM3R2EWT.js");
      await import("./w3m-modal-R7OR2ALO.js");
...
*/
//# sourceMappingURL=core-GZHYL75L.js.map
